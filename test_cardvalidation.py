...
womenHatPriceText = driver.find_element_by_xpath("//*[@class='a-spacing-mini']/span[1]").text
menHatPriceText = driver.find_element_by_xpath("//*[@class='a-spacing-mini']/span[2]").text
subtotalPriceText = driver.find_element_by_xpath("//*[@id='sc-subtotal-amount-activecart']/span").text
...
menHatPriceText = driver.find_element_by_xpath("//*[@class='a-spacing-mini']/span[0]").text
womenHatPriceText = driver.find_element_by_xpath("//*[@class='a-spacing-mini']/span[1]").text
subtotalPriceText = driver.find_element_by_xpath("//*[@id='sc-subtotal-amount-activecart']/span").text
